...
class FloorTable(NetBoxTable):
    ...
    placement_count = columns.LinkedCountColumn(
        viewname='plugins:netbox_spatial_lens:rackplacement_list',
        url_params={'floor_id': 'pk'},
        verbose_name='Racks',
    )
    tags = columns.TagColumn(url_name='plugins:netbox_spatial_lens:floor_list')
...
class RackPlacementTable(NetBoxTable):
    ...
    tags = columns.TagColumn(url_name='plugins:netbox_spatial_lens:rackplacement_list')
...
class FloorLayerTable(NetBoxTable):
    ...
    tags = columns.TagColumn(url_name='plugins:netbox_spatial_lens:floorlayer_list')
