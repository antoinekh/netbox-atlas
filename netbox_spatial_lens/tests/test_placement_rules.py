...
from netbox_spatial_lens.forms import FloorForm
from netbox_spatial_lens.layout import unplaced_racks
...
class PlacementLocationTest(LensTestCase):
    def setUp(self):
...
class PlacementBoundsTest(LensTestCase):
...
class FloorFormTest(LensTestCase):
    def _form(self, **data):
...
class LayerFileTest(LensTestCase):
    def setUp(self):
