...
from netbox_spatial_lens.tests.base import make_floor, make_rack, place
...
class BranchTest(TransactionTestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(username='lens', is_superuser=True)
        ...
        self.branch = Branch(name='Lens branch')
    ...
    def test_the_plugin_tables_are_replicated(self):
        ...
        self.assertIn('netbox_spatial_lens_floor', tables)
        self.assertIn('netbox_spatial_lens_rackplacement', tables)
        self.assertIn('netbox_spatial_lens_floorlayer', tables)
    ...
    def test_the_floor_list_follows_the_branch(self):
        ...
        url = reverse('plugins:netbox_spatial_lens:floor_list')
