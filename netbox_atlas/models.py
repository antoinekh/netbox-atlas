...
class Floor(PrimaryModel):
    ...
    def get_absolute_url(self) -> str:
        return reverse('plugins:netbox_atlas:floor', args=[self.pk])
...
def layer_upload_path(instance, filename: str) -> str:
    ...
    """
    return f'netbox-atlas/floor-{instance.floor_id}/{filename}'
