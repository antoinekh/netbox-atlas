...
from netbox_atlas.overlays import NO_DATA_COLOUR, UTILISATION_LEGEND, Colouring, LegendEntry, RackValue
...
logger = logging.getLogger('netbox.plugins.netbox_atlas.device_overlays')
