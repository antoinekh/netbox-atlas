...
class FloorSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(view_name='plugins-api:netbox_atlas-api:floor-detail')
...
class RackPlacementSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(view_name='plugins-api:netbox_atlas-api:rackplacement-detail')
...
class FloorLayerSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(view_name='plugins-api:netbox_atlas-api:floorlayer-detail')
    floor = FloorSerializer(nested=True)
