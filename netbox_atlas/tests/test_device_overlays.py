...
from netbox_atlas.device_overlays import (
    cabling_overlay,
    get_device_overlay,
    role_overlay,
    status_overlay,
...
from netbox_atlas.palette import categorical_colour, completion_colour
...
class DeviceOverlayTest(AtlasTestCase):
    def setUp(self):
...
class ReservationTest(AtlasTestCase):
    """
