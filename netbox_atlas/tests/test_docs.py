...
from netbox_atlas.overlays import UTILISATION_LEGEND, Overlay
...
class ExtendingExampleTest(AtlasTestCase):
    def setUp(self):
        namespace = {}
        exec(_example('# yourplugin/atlas.py'), namespace)
    ...
    def test_the_registration_example_names_real_functions(self):
        ...
        from netbox_atlas import overlays
