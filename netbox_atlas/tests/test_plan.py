...
from netbox_atlas.geometry import metre_step, metre_ticks, size_labels
from netbox_atlas.layout import build_layout, floor_summary
from netbox_atlas.overlays import floor_space_utilisation, get_overlay
...
class MetreScaleTest(AtlasTestCase):
...
class LabelSizingTest(AtlasTestCase):
    _floors = 0
...
class SpaceUtilisationTest(AtlasTestCase):
    """
...
class FreeBandTest(AtlasTestCase):
    """
...
class SummaryTest(AtlasTestCase):
