...
- **Floor in 3D:** the floor opens in 3D, each rack a cabinet at its real position, rotation and height, coloured by the floor's colouring with the reading on its doors, and the cable runs as arcs over the racks and to the walls. A 3D and 2D switch keeps the plan one click away, and the floor falls back to 2D when 3D cannot be drawn. The legend, finders, find box and rack table work in both.
